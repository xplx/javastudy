...
public class StringUtil {
    ...
    public static byte[] compressToByte(String str) throws IOException {
        ...
        gzip.write(str.getBytes(Constants.ENCODING));
        gzip.close();
    ...
    public static String subTime() {
        ...
        String subTime = time.substring(time.length() - 10, time.length());
        return subTime;
    }
     ...
     * @return
     */
    public static String moveSpecialCode (String str) {
        str = replace(str, "\r\n", "");
        str = replace(str, "\r", "");
        str = replace(str, "\n", "");
        str = replace(str, "\t", "");
