...
import static pers.wxp.util.BeanUtil.requireNonNull;

/**
 * Class description
 * json操作工具类，基于fastjson封装
 *
 * @version        1.0, 17/06/30
 * @author         WJ
 */
public final class JSONUtil {
    ...
    public static <T> String toJson(T obj) {
        ...
        String jsonStr = JSON.toJSONString(obj, DEFAULT_FORMAT);
        return  StringUtil.moveSpecialCode(jsonStr);
    }
    ...
    public static String toJson(Map<String, Object> map) {
        ...
        String jsonStr = JSON.toJSONString(map, DEFAULT_FORMAT);
        return StringUtil.moveSpecialCode(jsonStr);
    }
